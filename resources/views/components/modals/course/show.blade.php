<div class="modal fade" id="courseShowModal" tabindex="-1" role="dialog" aria-labelledby="courseShowModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5 class="modal-title" id="courseShowModalLabel"></h5>
